        ...
        <div className='container mx-auto px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                ...
                <div className='w-20 h-20 rounded-full bg-amber-600/20 flex items-center justify-center mb-6'>
                    <img src="/public/images/Free WHM & cPanel.png" alt="cPanel" />
                </div>
                ...
                <div className='w-[100%] h-80 border border-[#9824f4]/80 rounded-2xl shadow-2xl p-10'>
                <div className='w-20 h-20 rounded-full  bg-amber-600/20 flex items-center justify-center mb-6'>
                    <img src="/public/images/Performance_Optimized_icon.png" alt="Performance" />
                </div>
                ...
                <div className='w-[100%] h-80 border border-[#9824f4]/80 rounded-2xl shadow-2xl p-10'>
                <div className='w-20 h-20 rounded-full  bg-amber-600/20 flex items-center justify-center mb-6'>
                    <img src="/public/images/Super Easy to Use-icon.png" alt="" />
                </div>
                ...
                <div className='w-[100%] h-80 border border-[#9824f4]/80 rounded-2xl shadow-2xl p-10'>
                <div className='w-20 h-20 rounded-full  bg-amber-600/20 flex items-center justify-center mb-6'>
                    <img src="/public/images/Expert_Support-icon.png" alt="Expert Support" />
                </div>
